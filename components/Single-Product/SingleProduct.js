...
const SingleProduct = ({ checkMatchProduct, book }) => {
  const [tab, setTab] = useState(false);

  return (
    <>
      <BreadCrumb title={`${book?.title}`}text={`${book?.title}`} />
              ...
              >
                ...
                >
                  <a
                    ...
                    aria-selected="true"
                  >
                    <span className="title">Düşindiriliş</span>
                  </a>
                </li>
                <li
                  className="nav-item"
                ...
                >
                  <a
                    ...
                    aria-selected="false"
                  >
                    <span className="title">Teswirler</span>
                  </a>
                </li>
              </ul>
              ...
              >
                ...
                <div className="rbt-comment-form mt--50 rbt-shadow-box">
                  <div className="comment-form-inner">
                    <h3 className="title">Teswir goş</h3>
                  </div>
                  <ReviewForm />
                </div>
              </div>
            ...
            <div className="col-lg-12">
              <div className="section-title text-center mb--50">
                <span className="subtitle bg-secondary-opacity">
                  baglanyşykly kitaplar
                </span>
                <h2 className="title">Meňzeş kitaplar.</h2>
              </div>
            </div>
          </div>
